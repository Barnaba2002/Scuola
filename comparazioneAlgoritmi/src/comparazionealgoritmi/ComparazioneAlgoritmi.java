...
public class ComparazioneAlgoritmi
{
    /**
    ...
    public static void main(String[] args)
    {
        ...
        long seed;
		System.out.print("Inserisci un seed(utlizza lo stesso per ottenere gli stessi risulati): ");
		seed = key.nextLong();
